...
d3.csv("data.csv", function(err, data) {
  ...
  data.forEach(function(censusData) {
    censusData.percentPoverty = +censusData.percentPoverty;
    censusData.noHealthInsurance = +censusData.noHealthInsurance;
    censusData.mediumIncome = +censusData.mediumIncome;
  });
